...
const Hero = () => (
  ...
  <button className='flex flex-row border-none rounded-xl bg-yellow-600 text-white m-2 pl-2 p-2 hover:bg-yellow-400 hover:text-black border items-center'>GetStarted <img src={arrow} alt="arrow" className='p-1 w-6' /></button>
  </div>
  <div className='m-4 rounded-full bg-gradient-to-r from-black to-blue-500 '>
    <img src={hero} alt="blogs" className='z-10'/>
  </div>
  </div>
);
